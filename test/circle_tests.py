...
class CircleTests(unittest.TestCase):
    ...
    def test_atualizandoCirculoExistente(self): #Os Codigos de test estão com Problema. Esse que eu modifiquei mostra.
        self.assertTrue(self.gcont.createCircle(self.FAMILIA, 3), "O circulo deve ser adicionado")
        test = Circulo(self.FAMILIA, 4) #adicionei isso e o test passou! PQ antes eles tinha Endereço diferentes
        self.assertTrue(self.gcont.updateCircle(test), "O circulo deve ser atualizado")
        self.assertEqual(self.gcont.getCircle(self.FAMILIA), test, "O circulo nao foi atualizado corretamente")
